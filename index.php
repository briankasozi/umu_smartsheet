...
<body class="bg-gray-50">
    <!-- Main Sidebar -->
    <div id="mainSidebar" class="sidebar-main bg-[#1a73e8] flex flex-col">
        <button id="sidebarToggle" class="flex items-center px-4 py-3 hover:bg-blue-700">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"/>
            </svg>
            <span class="menu-item-text font-medium">Menu</span>
        </button>

        <nav class="flex-1 py-2 text-white">
            ...
            <a href="controllers/task_list.php" class="menu-item">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="controllers/user_list.php" class="menu-item">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mt-auto pb-4">
            <a href="#" class="menu-item relative">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div id="mainContent" class="pl-[31rem] pr-4 pt-4">
        <div class="bg-white rounded-lg shadow p-6 mb-6">
            <h1 class="text-2xl font-semibold text-gray-800">Welcome to TagDev2.0 Project Management</h1>
        </div>
