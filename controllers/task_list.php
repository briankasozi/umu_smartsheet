...
<div class="flex min-h-screen">
    ...
    <aside class="hidden md:flex flex-col w-56 bg-gray-800 text-white py-8 px-4 fixed h-full z-10">
        ...
        <ul class="space-y-4">
            ...
            <li><a href="#" class="text-blue-300 font-semibold cursor-default">Tasks</a></li>
            <li><a href="../controllers/user_list.php" class="hover:text-yellow-400 font-semibold">Manage Users</a></li>
        </ul>
    </aside>
    <!-- Main Content -->
