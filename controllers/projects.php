<?php
// controllers/projects.php - Professional projects page
$active = 'projects';
...
<head>
    <meta charset="UTF-8">
    <title>Projects | TagDev2.0</title>
                        ...
                        <body class="bg-gray-50">
                            ...
                            <div id="mainSidebar" class="sidebar-main bg-[#1a73e8] flex flex-col">
                                ...
                                <nav class="flex-1 py-2 text-white">
                                    ...
                                    <a href="task_list.php" class="menu-item">
                                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div id="secondarySidebar" class="fixed top-0 bottom-0 w-64 bg-white border-r border-gray-200 z-30" style="left: 15rem;">
                                <div class="p-4">
                                    <h1 class="text-lg font-medium mb-4">Projects</h1>
